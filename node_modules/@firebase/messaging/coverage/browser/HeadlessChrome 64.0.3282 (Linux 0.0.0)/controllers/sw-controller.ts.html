...
<html lang="en">
<head>
    <title>Code coverage report for controllers/sw-controller.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">controllers</a> sw-controller.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">93.97% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>109/116</span>
      </div>
      <div class='fl pad1y space-right2'>
...
379
380
381</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >        return registration.pushManager</span>
          .getSubscription()
          .then(<span class="fstat-no" title="function not covered" >subscription =&gt; {</span>
          ...
          .catch(<span class="fstat-no" title="function not covered" >err =&gt; {</span>
            ...
            const tokenDetailsModel = <span class="cstat-no" title="statement not covered" >this.getTokenDetailsModel();</span>
<span class="cstat-no" title="statement not covered" >            return tokenDetailsModel</span>
              .getTokenDetailsFromSWScope(registration.scope)
              .then(<span class="fstat-no" title="function not covered" >tokenDetails =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                if (!tokenDetails) {</span>
...
<span class="cstat-no" title="statement not covered" >                return this.deleteToken(tokenDetails['fcmToken']).then(<span class="fstat-no" title="function not covered" >() =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >                  throw err;</span>
                });
              });
          });
