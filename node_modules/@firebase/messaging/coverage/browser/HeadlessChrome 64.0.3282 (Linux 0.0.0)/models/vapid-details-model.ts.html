...
<html lang="en">
<head>
    <title>Code coverage report for models/vapid-details-model.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">models</a> vapid-details-model.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
    return this.openDatabase().then(db =&gt; {
      return new Promise&lt;Uint8Array&gt;((resolve, reject) =&gt; {
        ...
        scopeRequest.onerror = <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          reject(scopeRequest.error);</span>
        };
&nbsp;
...
&nbsp;
    return this.openDatabase().then(db =&gt; {
      return new Promise&lt;void&gt;((resolve, reject) =&gt; {
        ...
        request.onerror = <span class="fstat-no" title="function not covered" >() =&gt; {</span>
...
<span class="cstat-no" title="statement not covered" >            reject(request.error);</span>
          ...
          request.onsuccess = () =&gt; {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (request.result === 0) {
