...
<html lang="en">
<head>
    <title>Code coverage report for models/token-details-model.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">models</a> token-details-model.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
/** @record */
<span class="fstat-no" title="function not covered" >function ValidateInput() {</span>}
...
&nbsp;
  onDBUpgrade(db: IDBDatabase, evt: IDBVersionChangeEvent) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (evt.oldVersion &lt; 1) {
      // New IDB instance
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (evt.oldVersion &lt; 2) {
...
<span class="cstat-no" title="statement not covered" >            reject((&lt;IDBRequest&gt;event.target).error);</span>
          };
    ...
    return this.validateInputs_({ swScope })
      ...
      .then(db =&gt; {
        return new Promise((resolve, reject) =&gt; {
          ...
          scopeRequest.onerror = <span class="fstat-no" title="function not covered" >event =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            reject((&lt;IDBRequest&gt;event.target).error);</span>
          };
&nbsp;
...
&nbsp;
        return new Promise((resolve, reject) =&gt; {
          ...
          request.onerror = <span class="fstat-no" title="function not covered" >event =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            reject((&lt;IDBRequest&gt;event.target).error);</span>
          };
...
<span class="cstat-no" title="statement not covered" >            reject((&lt;IDBRequest&gt;event.target).error);</span>
          ...
          request.onsuccess = event =&gt; {
            <span class="missing-if-branch" title="if path not taken" >I</span>if ((&lt;IDBRequest&gt;event.target).result === 0) {
