...
<html lang="en">
<head>
    <title>Code coverage report for models/iid-model.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">models</a> iid-model.ts
    </h1>
    <div class='clearfix'>
    ...
    return fetch(
      ...
      if (!fetchResponse.ok) {
        return fetchResponse.json().then(
          fcmTokenResponse =&gt; {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (fcmTokenResponse['error']) {
              const message = fcmTokenResponse['error']['message'];
              throw this.errorFactory_.create(
