...
var PersistentStream = /** @class */ (function () {
    function PersistentStream(queue, connectionTimerId, idleTimerId, connection, credentialsProvider) {
        ...
        this.stream = null;
        this.listener = null;
        this.backoff = new backoff_1.ExponentialBackoff(queue, connectionTimerId, BACKOFF_INITIAL_DELAY_MS, BACKOFF_FACTOR, BACKOFF_MAX_DELAY_MS);
            ...
            _this.queue.enqueue(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_a) {
                    if (this.state !== PersistentStreamState.Stopped) {
                        rpcError = new error_1.FirestoreError(error_1.Code.UNKNOWN, 'Fetching auth token failed: ' + error.message);
    ...
    PersistentStream.prototype.performBackoff = function (listener) {
        ...
        this.backoff.backoffAndRun(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                ...
                this.state = PersistentStreamState.Initial;
                this.start(listener);
                assert_1.assert(this.isStarted(), 'PersistentStream should have started');
                return [2 /*return*/];
            });
        }); });
    };
...
var PersistentListenStream = /** @class */ (function (_super) {
    ...
    function PersistentListenStream(queue, connection, credentials, serializer) {
        var _this = _super.call(this, queue, async_queue_1.TimerId.ListenStreamConnection, async_queue_1.TimerId.ListenStreamIdle, connection, credentials) || this;
...
var PersistentWriteStream = /** @class */ (function (_super) {
    ...
    function PersistentWriteStream(queue, connection, credentials, serializer) {
        var _this = _super.call(this, queue, async_queue_1.TimerId.WriteStreamConnection, async_queue_1.TimerId.WriteStreamIdle, connection, credentials) || this;
        _this.serializer = serializer;
