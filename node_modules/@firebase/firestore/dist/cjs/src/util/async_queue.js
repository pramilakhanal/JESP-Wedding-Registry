...
})(TimerId = exports.TimerId || (exports.TimerId = {}));
/**
...
var DelayedOperation = /** @class */ (function () {
    function DelayedOperation(asyncQueue, timerId, targetTimeMs, op, removalCallback) {
        ...
        this.deferred = new promise_1.Deferred();
    ...
    DelayedOperation.prototype.cancel = function (reason) {
        if (this.timerHandle !== null) {
            this.clearTimeout();
            this.deferred.reject(new error_1.FirestoreError(error_1.Code.CANCELLED, 'Operation cancelled' + (reason ? ': ' + reason : '')));
        }
    };
...
var AsyncQueue = /** @class */ (function () {
    ...
    AsyncQueue.prototype.enqueueAfterDelay = function (timerId, delayMs, op) {
        ...
        assert_1.assert(!this.containsDelayedOperation(timerId), "Attempted to schedule multiple operations with timer id " + TimerId[timerId] + ".");
    ...
    AsyncQueue.prototype.runDelayedOperationsEarly = function (lastTimerId) {
        ...
        return this.drain().then(function () {
            assert_1.assert(lastTimerId === undefined || _this.containsDelayedOperation(lastTimerId), "Attempted to drain to missing operation " + lastTimerId);
    ...
    AsyncQueue.prototype.removeDelayedOperation = function (op) {
        ...
        assert_1.assert(index >= 0, 'Delayed operation not found.');
