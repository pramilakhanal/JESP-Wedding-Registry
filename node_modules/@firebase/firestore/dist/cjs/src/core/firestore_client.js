...
var FirestoreClient = /** @class */ (function () {
    ...
    FirestoreClient.prototype.startIndexedDbPersistence = function () {
        ...
        var serializer = new serializer_1.JsonProtoSerializer(this.databaseInfo.databaseId, {
            useProto3Json: true
        });
    ...
    FirestoreClient.prototype.initializeRest = function (user) {
        ...
        return this.platform
            ...
            var datastore = new datastore_1.Datastore(_this.asyncQueue, connection, _this.credentials, serializer);
